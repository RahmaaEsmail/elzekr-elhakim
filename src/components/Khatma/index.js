            ...
            {console.log(currentDay,"currentDaycurrentDay")}
              {
                  ...
                  <div>
                    {
                      ...
                      {console.log(times,"times")}
                        {/**/}
                        <h5 style={{color:"#404040"}}>{currentDay[0]['surah_title']} {currentDay[0]['numberInSurah']}</h5>
                  ...
                  <div>
                    {
                      <>
                        {/**/}
                        <h5 style={{color:"#404040"}}>{currentDay[currentDay.length-1]['surah_title']} {currentDay[currentDay.length-1]['numberInSurah']}</h5>
                        <div onClick={() => {
                ...
                <div className='read_done'>
                  <h6 style={{color:"#404040"}}>تمت قراءة {readenPages} من 604</h6>
                  <p style={{color:"#9B102C"}}>{Math.floor((readenPages / 604) * 100)}%</p>                      </div>
                ...
                <div>
                  ...
                  <h6 style={{color:"#404040"}}>عدد الأيام المتبقيه {totalPages*1-currentTi*1+1}</h6>
                </div>
                ...
                <div onClick={() => {
                  ...
                  <FaRegTrashCan />
                  <span style={{color:"#404040"}}>مسح</span>
                </div>
              </>
...

              {
                false&&<>
                  ...
                  <div onClick={()=>{
                    ...
                    <FaRegTrashCan style={{color:"#9B102C"}} />
                    <span>مسح</span>
                  </div>
                </>
              }
